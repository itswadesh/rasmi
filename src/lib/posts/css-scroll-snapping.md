...
I've recently added scroll snapping to my own website. You can check it out on the "Work Experience" section in the [Home page](https://rasmi.github.io). It's specially great on mobile!
...
<iframe height="500" style="width: 100%;" scrolling="no" title="scroll-snap-type: Mandatory vs Proximity" src="https://codepen.io/itrasmi/embed/preview/LYNPdpE?default-tab=result&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/itrasmi/pen/LYNPdpE">
  scroll-snap-type: Mandatory vs Proximity</a> by Rasmi (<a href="https://codepen.io/itrasmi">@itrasmi</a>)
