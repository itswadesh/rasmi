...
- I built [my Resume as a Web Component](https://github.com/itrasmi/resume) - using StencilJS to build it, and CSS Grid for the layout. Both of those things were new to me, so it was pretty interesting;
