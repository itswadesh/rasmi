# rasmi.github.io / rasmi.github.io
...
I've built an image-optimizer script called [image-transmutation](https://github.com/itrasmi/image-transmutation) that is used on this website. For now, you have to run it manually, while I don't push it to npm.
